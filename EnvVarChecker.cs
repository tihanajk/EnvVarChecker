...
namespace EnvVarChecker
{
    ...
    [Export(typeof(IXrmToolBoxPlugin)),
        ...
        "Retrieve environment variable information and compare it across up to three environments (for example, DEV, UAT and PROD) to identify any differences in their values"),
